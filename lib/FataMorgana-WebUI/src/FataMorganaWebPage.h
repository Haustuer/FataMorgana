  ...
  <div class="layout">
    <section class="card">
      ...
      <form id="configForm">
        ...
        <h3>Out-of-Bounds Handling</h3>
        <div class="form-grid">
          <label>OOB Mode<select id="oobMode"><option value="0">Black (safe default)</option><option value="1">Clamp (edge repeat)</option><option value="2">Mirror (reflect)</option></select></label>
        </div>
...
oobModeField=document.getElementById('oobMode'),
...
oobModeField.addEventListener('change',autoSave);
